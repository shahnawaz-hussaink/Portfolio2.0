const projects = [
    ...
    },
    {
      ...
      image: "./netflix.webp",
      desc: "I built a simple yet visually appealing Netflix clone using HTML, CSS, and JavaScript. The project focuses on clean layout, responsive design, and smooth user interactions, closely mimicking the look and feel of the original platform's landing page.",
    ...
    },
    {
      ...
      stack: [
        ...
        "API: Dog CEO’s Dog API (https://dog.ceo)",
        "Features: Fetch API, async/await, DOM manipulation",
      ],
